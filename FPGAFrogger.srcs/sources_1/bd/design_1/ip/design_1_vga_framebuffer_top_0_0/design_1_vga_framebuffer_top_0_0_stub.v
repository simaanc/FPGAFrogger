...
/* synthesis syn_black_box black_box_pad_pin="clk_pix,rst_pix,cpu_we,cpu_addr[15:0],cpu_dat[3:0],VGA_Hsync,VGA_Vsync,VGA_Red[3:0],VGA_Green[3:0],VGA_Blue[3:0]" */;
  input clk_pix;
  input rst_pix;
  input cpu_we;
  input [15:0]cpu_addr;
