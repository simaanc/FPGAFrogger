...
#define XPAR_PMODKYPD_0_AXI_LITE_GPIO_BASEADDR 0x00010000
#define XPAR_PMODKYPD_0_AXI_LITE_GPIO_HIGHADDR 0x00010FFF
...
/* Definitions for peripheral AXI_GPIO_ADDR */
#define XPAR_AXI_GPIO_ADDR_BASEADDR 0x40020000
#define XPAR_AXI_GPIO_ADDR_HIGHADDR 0x4002FFFF
#define XPAR_AXI_GPIO_ADDR_DEVICE_ID 1
#define XPAR_AXI_GPIO_ADDR_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_ADDR_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_DAT */
#define XPAR_AXI_GPIO_DAT_BASEADDR 0x40030000
#define XPAR_AXI_GPIO_DAT_HIGHADDR 0x4003FFFF
#define XPAR_AXI_GPIO_DAT_DEVICE_ID 2
#define XPAR_AXI_GPIO_DAT_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_DAT_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_VSYNC */
#define XPAR_AXI_GPIO_VSYNC_BASEADDR 0x40040000
#define XPAR_AXI_GPIO_VSYNC_HIGHADDR 0x4004FFFF
#define XPAR_AXI_GPIO_VSYNC_DEVICE_ID 3
#define XPAR_AXI_GPIO_VSYNC_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_VSYNC_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_WE */
#define XPAR_AXI_GPIO_WE_BASEADDR 0x40010000
#define XPAR_AXI_GPIO_WE_HIGHADDR 0x4001FFFF
#define XPAR_AXI_GPIO_WE_DEVICE_ID 4
#define XPAR_AXI_GPIO_WE_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_WE_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_FRAME_RDY */
#define XPAR_AXI_GPIO_FRAME_RDY_BASEADDR 0x40050000
#define XPAR_AXI_GPIO_FRAME_RDY_HIGHADDR 0x4005FFFF
#define XPAR_AXI_GPIO_FRAME_RDY_DEVICE_ID 5
#define XPAR_AXI_GPIO_FRAME_RDY_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_FRAME_RDY_IS_DUAL 0
